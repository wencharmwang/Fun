...
public class GanksFragment extends BaseFragment implements GanksContract.IView {
	...
	static class GankHolder extends RecyclerView.ViewHolder {
		...
		void bind(BaseActivity activity, Gank.GankInfo gankInfo) {
			...
			card.setOnClickListener(v -> {
				...
				activity.getSupportFragmentManager().beginTransaction().replace(R.id.content, fragment).addToBackStack(TAG).commit();
			});
		}
